...
import SingleWorkRollDetailView from '../Main/SingleWorkRollDetailView';
import IssueDetailView from '../Main/IssueDetailView';
...
export default class MyWitnessReceiveListView extends Component {
    constructor(props) {
        super(props)
       ...
       LOADING = {};
       var isMyevent = false;
        if (this.matchRoles('/witness/myevent')) {
            isMyevent = true;
        }
    ...
    executeNextPageNetWorkRequest(pagesize,pagenum,query){
      ...
      console.log('executeNextPageNetWorkRequest:pagesize = ' + pagesize+";pagenum="+pagenum+";query="+query)
            ...
            var cachedResultsForQuery = resultsCache.dataForQuery[query];
                 ...
                 var paramBody = {}
                 var requestUrl = '/hdxt/api/baseservice/witness';
                 if (this.state.isMyevent) {
                     requestUrl = '/hdxt/api/baseservice/witness/myevent';
                     paramBody = {
                             'condition':'equal',
                             'pagesize':pagesize,
                             'pagenum':pagenum,
                             'categoryFilter':this.props.data.id,
                         }
                 }else{
                     paramBody = {
                             'condition':null,
            ...
            HttpRequest.get(requestUrl, paramBody, this.onGetDataSuccess.bind(this),
                (e) => {
                    LOADING[query] = false;
